		...
		<div className="admin__shell">
			...
			<div className={`admin__side-bar ${burger ? 'active' : ''}`}>
				...
				<ul className="side-bar__list">
					...
					<li><Link className={`side-bar__list_link ${id === 'electronic' ? 'active' : ''}`} to={'/admin/electronic'}>{t("electronic")}</Link></li>
					<li><Link className={`side-bar__list_link ${id === 'create-electronic' ? 'active' : ''}`} to={'/admin/create-electronic'}>{t("createElectronic")}</Link></li>
